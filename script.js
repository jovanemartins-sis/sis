                ...
                <tr>
                    ...
                    <td>
                        <select class="fluxo-select">
                            <option value="nota-etiqueta" selected>Emitir Nota/Etiqueta</option>
                            <option value="so-etiqueta">Somente Etiqueta</option>
                        </select>
                    </td>
...
function setupCadastroIntegracao() {
    ...
    // =======================================================
    // **LÓGICA CRÍTICA DE SALVAMENTO DA SHOPEE (Corrigida)**
    // Garantimos que o evento seja anexado corretamente.
    // =======================================================
    if (salvarShopeeBtn) {
        // Remove qualquer listener anterior para evitar duplicidade
        // Isso é crucial para elementos injetados dinamicamente
        ...
        salvarShopeeBtn = newSalvarShopeeBtn; // Atualiza a referência
        ...
        salvarShopeeBtn.addEventListener('click', () => {
            ...
            // 2. Validação
            if (descricao === '' || partnerId === '' || empresaId === '') {
            ...
            // Chama o carregamento da página para refletir as mudanças
            loadPage('integracoes'); 
        });
    }
}
...
// HTML do Modal de Cadastro de Empresa
...
function setupCadastroEmpresa() {
    ...
    form.addEventListener('submit', (e) => {
        ...
        if (razaoSocial && cnpj) {
            ...
            modal.style.display = 'none';
            form.reset();
            loadPage('empresas'); // Recarrega a página de empresas
        } else {
...
function setupCadastroIntegracao() {
    ...
    const shopeeForm = document.getElementById('shopee-form');
    const cancelarShopeeBtn = document.getElementById('cancelar-shopee');
    // **AQUI ESTÁ O SEGREDO:** Captura o botão dentro do modal.
    ...
    if (salvarShopeeBtn) {
        ...
        newSalvarShopeeBtn.addEventListener('click', () => {
